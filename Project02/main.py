...
def run_soybean_experiment(run_knn=False, run_eknn=False, run_kmeans=False):
    ...
    if run_kmeans:
        ...
        all_params_kmeans = tuning_utility_kmeans.tune_k_for_folds(training_test_data, tuning_data, k_range=[1,3], clusters=clusters)
        ...
        with open("soybeans-kmeans-best-params.bin", 'wb+') as f:
